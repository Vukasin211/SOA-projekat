...
def uploadDeviceProfile():
    multipart_data = MultipartEncoder(
        fields={
            'file': ('D:\SOA-Projekat\Projekat III\App\deviceCreation\RESTDeviceProfile.yaml', open('D:\SOA-Projekat\Projekat III\App\deviceCreation\RESTDeviceProfile.yaml', 'rb'), 'text/plain')
        }
    )
