...
colors = dict()
colors['DC_POWER'] = "green"
colors['AC_POWER'] = "green"
colors['DAILY_YIELD'] = "green"
...
def stuff():
    global colors
    return jsonify(colorDC_POWER=colors['DC_POWER'], colorsAC_POWER=colors['AC_POWER'], colorsDAILY_YIELD=colors['DAILY_YIELD'])
